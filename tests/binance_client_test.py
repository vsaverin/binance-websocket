...
async def test_parse_kline():
    ...
    result = binance_ws._parse_kline(kline_data)
...
async def test_on_message_error():
    ...
    with patch.object(
        ...
        await binance_ws.on_message(message_with_error)
...
async def test_on_message_no_kline():
    ...
    with patch.object(
        ...
        await binance_ws.on_message(message_without_kline)
        mock_write_data.assert_not_called()
...
async def test_on_message_successful_write():
    ...
    with patch.object(
        ...
        await binance_ws.on_message(valid_kline_message)
...
async def test_connect():
    ...
    with patch("websockets.connect") as mock_connect:
        ...
        mock_connect.assert_called_once_with(binance_ws.uri)
